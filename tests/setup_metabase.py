...
if __name__ == "__main__":
    ...
    user_responses = create_users(api_connection)
    coll_responses = create_collections(api_connection)
    card_responses = create_cards(api_connection)
    db_responses = create_databases(api_connection, server_version)
